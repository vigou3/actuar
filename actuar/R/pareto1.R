...
mpareto1 <- function(order, shape, min, log = FALSE)
     .External("do_dpq", "mpareto1", order, shape, min, log)

levpareto1 <- function(limit, shape, min, order = 1, log = FALSE)
     .External("do_dpq", "levpareto1", limit, shape, min, order, log)
