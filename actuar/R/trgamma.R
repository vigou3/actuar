...
###
### Definition of the {d,p,q,r,m,lev}transformed gamma functions. The
### transformed gamma distribution used in these functions has
### cumulative distribution function
###
###   Pr[X <= x] = pgamma((x / scale)^shape2, shape1, 1), x > 0.
###
