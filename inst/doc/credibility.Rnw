...
The solution proposed by \cite{Buhlmann:regression:1997} \citep[see
also][Section~8.4]{Buhlmann_Gisler} is simply to position the
intercept at the barycenter of time instead of at time origin. In
