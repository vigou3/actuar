...
When \code{formula} is \code{"bayes"}, function \code{cm} computes
pure Bayesian premiums for the combinations of distributions above. We
identify which by means of argument \code{likelihood} that must be one
of %
\code{"poisson"}, %
\code{"exponential"}, %
\code{"gamma"}, %
...
\code{dbeta}, \code{dbinom} or \code{dnbinom}, as appropriate.
