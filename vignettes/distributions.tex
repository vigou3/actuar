...
\begin{align*}
  \mu_2 &= \sigma^2 = \phi\mu^3 + \mu \\
  \mu_3 &= 3 \phi \mu^2 \sigma^2 + \mu.
\end{align*}
...
finite strictly positive, integer moments, and so neither does the
Poisson-inverse Gaussian. The pmf reduces to
\begin{equation*}
